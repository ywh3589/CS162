...
printf("%s:%d\n",__FILE__,__LINE__);
     ...
     //  sleep(1);
       ...
       //variable is needed to make the next fighter fights each other 
         ...
         //     pQueue[1].PrintQueue();
            cout << "c " << c << " " << "b " << b << endl;
            if((pQueue[0].GetFront() == NULL) ||(pQueue[1].GetFront() == NULL) || (result == 3))//  if( c == b)
            {
               cout << "break" << endl;
    ...
    {/*both creatures die*/
        if(fighter2_sp <= 0)
        {
            ...
            else
            {
                ...
                cout << "updated strenght " <<  pQueue[0].GetFront()->GetCreature()->GetStrength() << endl;
                ...
                cout << "updated strenght " <<  pQueue[1].GetFront()->GetCreature()->GetStrength() << endl;
               ...
               //    string ch_name_1 = pQueue[1].GetFront()->GetCreature()->GetName();
                   if(ch_name_0 == "Harry Potter") 
                   {
                      pQueue[0].GetFront()->GetCreature()->SetLifeChance(1);
                        cout << pQueue[0].GetFront()->GetCreature()->GetLifeChance() << endl;
                        sleep(2);
                   }
                   if(ch_name_1 == "Harry Potter") 
                   {
                       pQueue[1].GetFront()->GetCreature()->SetLifeChance(1);
                        cout << pQueue[1].GetFront()->GetCreature()->GetLifeChance() << endl;
                        sleep(2);
                   }
