...
/********************************************************************* 
** Function : GetEntry
** Description : returning the first number stored in the queue
** Parameters : none
** Pre-Conditions : queue -like structure.
** Post-Conditions : printing the numbers stored in the queue and returning the value stored at the front of the queue.
*********************************************************************/
int DynCharQueue::GetEntry()
{  
