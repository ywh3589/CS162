...
*********************************************************************/
        State::State(int i)
        {
            pEastQueue = new DynCharQueue;
            pWestQueue = new DynCharQueue;
            pNorthQueue = new DynCharQueue;
            pSouthQueue = new DynCharQueue;

            cout << "4 queues made" << endl;
...
** Post-Conditions : setting some number to object which can be refered as certain state of the object                                            setting number of cars at each lane 0 initially. 
*********************************************************************/
        DynCharQueue* State::GetQueue(int i)
        {
            if(i == 0)
            return pEastQueue;
            else if(i == 1)
