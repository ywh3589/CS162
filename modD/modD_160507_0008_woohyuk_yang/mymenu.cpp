...
** Post-Conditions : inputing and validating the number of ants to be made
*********************************************************************/
...
/********************************************************************* 
** Function : NumOfDoodleBugsInput()
** Description : A function validating the input value for number of critters to be made
** Parameters : grid size.
** Pre-Conditions : the size of the grid from the user
** Post-Conditions : inputing and validating the number of doodlebugs to be made
*********************************************************************/
